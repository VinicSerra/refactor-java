...
public class PetService {
    ...
    private HttpResponse<String> requestGet(String uri,HttpClient client) throws IOException, InterruptedException {
    ...
    public HttpResponse<String> requestPost(HttpClient client,String uri,JsonObject json) throws IOException, InterruptedException {
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(uri))
