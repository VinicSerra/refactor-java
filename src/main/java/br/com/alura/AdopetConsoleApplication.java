...
public class AdopetConsoleApplication {
   ...
   private static void cadastrarAbrigo() throws IOException, InterruptedException {
       ...
       HttpResponse<String> response =  requestGet(uri, client);
   ...
   private  static  HttpResponse<String> requestGet(String uri,HttpClient client) throws IOException, InterruptedException {
       HttpRequest request = HttpRequest.newBuilder()
               .uri(URI.create(uri))
   ...
   public static HttpResponse<String> requestPost(HttpClient client,String uri,JsonObject json) throws IOException, InterruptedException {
       HttpRequest request = HttpRequest.newBuilder()
               .uri(URI.create(uri))
               .header("Content-Type", "application/json")
               .method("POST", HttpRequest.BodyPublishers.ofString(json.toString()))
